#ifndef KEPLER_MATH_TRIG_HPP
#define KEPLER_MATH_TRIG_HPP
...
namespace trig {
// origin: xsimd/arch/generic/xsimd_generic_trigo.hpp
/****************************************************************************
...
template <class T>
inline bool reduce(const T& x, T& xr) noexcept {
  auto quad = trig::trig_reduce(x, xr);
