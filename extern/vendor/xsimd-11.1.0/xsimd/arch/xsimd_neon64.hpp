...
template <class A>
inline batch<double, A> set(batch<double, A> const&, requires_arch<neon64>, double d0,
                            double d1) noexcept {
  return float64x2_t{d0, d1};
}

template <class A>
inline batch_bool<double, A> set(batch_bool<double, A> const&, requires_arch<neon64>, bool b0,
                                 bool b1) noexcept {
...
template <class A>
inline batch<double, A> from_bool(batch_bool<double, A> const& arg,
...
template <class A>
inline batch<double, A> load_aligned(double const* src, convert<double>,
                                     requires_arch<neon64>) noexcept {
  return xsimd_aligned_load(vld1q_f64, double*, src);
}

template <class A>
inline batch<double, A> load_unaligned(double const* src, convert<double>,
                                       requires_arch<neon64>) noexcept {
...
template <class A>
inline void store_aligned(double* dst, batch<double, A> const& src,
                          requires_arch<neon64>) noexcept {
  vst1q_f64(dst, src);
}

template <class A>
inline void store_unaligned(double* dst, batch<double, A> const& src,
                            requires_arch<neon64>) noexcept {
...
template <class A>
inline batch<std::complex<double>, A> load_complex_aligned(std::complex<double> const* mem,
...
template <class A>
inline batch<std::complex<double>, A> load_complex_unaligned(std::complex<double> const* mem,
                                                             convert<std::complex<double>> cvt,
                                                             requires_arch<neon64>) noexcept {
...
template <class A>
inline void store_complex_aligned(std::complex<double>* dst,
...
template <class A>
inline void store_complex_unaligned(std::complex<double>* dst,
                                    batch<std::complex<double>, A> const& src,
                                    requires_arch<neon64>) noexcept {
...
template <class A>
inline batch<double, A> add(batch<double, A> const& lhs, batch<double, A> const& rhs,
                            requires_arch<neon64>) noexcept {
...
template <class A>
inline batch<double, A> sadd(batch<double, A> const& lhs, batch<double, A> const& rhs,
                             requires_arch<neon64>) noexcept {
...
template <class A>
inline batch<double, A> sub(batch<double, A> const& lhs, batch<double, A> const& rhs,
                            requires_arch<neon64>) noexcept {
...
template <class A>
inline batch<double, A> ssub(batch<double, A> const& lhs, batch<double, A> const& rhs,
                             requires_arch<neon64>) noexcept {
...
template <class A>
inline batch<double, A> mul(batch<double, A> const& lhs, batch<double, A> const& rhs,
                            requires_arch<neon64>) noexcept {
...
template <class A, class T, detail::enable_sized_unsigned_t<T, 8> = 0>
inline batch<T, A> div(batch<T, A> const& lhs, batch<T, A> const& rhs,
                       requires_arch<neon64>) noexcept {
...
#endif
template <class A>
inline batch<double, A> div(batch<double, A> const& lhs, batch<double, A> const& rhs,
                            requires_arch<neon64>) noexcept {
...
template <class A, class T, detail::enable_sized_unsigned_t<T, 8> = 0>
inline batch_bool<T, A> eq(batch<T, A> const& lhs, batch<T, A> const& rhs,
                           requires_arch<neon64>) noexcept {
...
template <class A>
inline batch_bool<double, A> eq(batch<double, A> const& lhs, batch<double, A> const& rhs,
                                requires_arch<neon64>) noexcept {
  return vceqq_f64(lhs, rhs);
}

template <class A, class T, detail::enable_sized_unsigned_t<T, 8> = 0>
inline batch_bool<T, A> eq(batch_bool<T, A> const& lhs, batch_bool<T, A> const& rhs,
                           requires_arch<neon64>) noexcept {
  return vceqq_u64(lhs, rhs);
}
...
template <class A>
inline batch_bool<double, A> eq(batch_bool<double, A> const& lhs, batch_bool<double, A> const& rhs,
                                requires_arch<neon64>) noexcept {
  return vceqq_u64(lhs, rhs);
}
...
template <class A>
inline batch<int64_t, A> fast_cast(batch<double, A> const& x, batch<int64_t, A> const&,
                                   requires_arch<neon64>) noexcept {
  return vcvtq_s64_f64(x);
}

template <class A>
inline batch<uint64_t, A> fast_cast(batch<double, A> const& x, batch<uint64_t, A> const&,
                                    requires_arch<neon64>) noexcept {
...
template <class A, class T, detail::enable_sized_unsigned_t<T, 8> = 0>
inline batch_bool<T, A> lt(batch<T, A> const& lhs, batch<T, A> const& rhs,
                           requires_arch<neon64>) noexcept {
...
template <class A>
inline batch_bool<double, A> lt(batch<double, A> const& lhs, batch<double, A> const& rhs,
                                requires_arch<neon64>) noexcept {
...
template <class A, class T, detail::enable_sized_unsigned_t<T, 8> = 0>
inline batch_bool<T, A> le(batch<T, A> const& lhs, batch<T, A> const& rhs,
                           requires_arch<neon64>) noexcept {
...
template <class A>
inline batch_bool<double, A> le(batch<double, A> const& lhs, batch<double, A> const& rhs,
                                requires_arch<neon64>) noexcept {
...
template <class A, class T, detail::enable_sized_unsigned_t<T, 8> = 0>
inline batch_bool<T, A> gt(batch<T, A> const& lhs, batch<T, A> const& rhs,
                           requires_arch<neon64>) noexcept {
...
template <class A>
inline batch_bool<double, A> gt(batch<double, A> const& lhs, batch<double, A> const& rhs,
                                requires_arch<neon64>) noexcept {
...
template <class A, class T, detail::enable_sized_unsigned_t<T, 8> = 0>
inline batch_bool<T, A> ge(batch<T, A> const& lhs, batch<T, A> const& rhs,
                           requires_arch<neon64>) noexcept {
...
template <class A>
inline batch_bool<double, A> ge(batch<double, A> const& lhs, batch<double, A> const& rhs,
                                requires_arch<neon64>) noexcept {
...
template <class A>
inline batch<double, A> bitwise_and(batch<double, A> const& lhs, batch<double, A> const& rhs,
                                    requires_arch<neon64>) noexcept {
  return vreinterpretq_f64_u64(vandq_u64(vreinterpretq_u64_f64(lhs), vreinterpretq_u64_f64(rhs)));
}

template <class A>
inline batch_bool<double, A> bitwise_and(batch_bool<double, A> const& lhs,
...
template <class A>
inline batch<double, A> bitwise_or(batch<double, A> const& lhs, batch<double, A> const& rhs,
                                   requires_arch<neon64>) noexcept {
  return vreinterpretq_f64_u64(vorrq_u64(vreinterpretq_u64_f64(lhs), vreinterpretq_u64_f64(rhs)));
}

template <class A>
inline batch_bool<double, A> bitwise_or(batch_bool<double, A> const& lhs,
                                        batch_bool<double, A> const& rhs,
                                        requires_arch<neon64>) noexcept {
...
template <class A>
inline batch<double, A> bitwise_xor(batch<double, A> const& lhs, batch<double, A> const& rhs,
                                    requires_arch<neon64>) noexcept {
  return vreinterpretq_f64_u64(veorq_u64(vreinterpretq_u64_f64(lhs), vreinterpretq_u64_f64(rhs)));
}

template <class A>
inline batch_bool<double, A> bitwise_xor(batch_bool<double, A> const& lhs,
                                         batch_bool<double, A> const& rhs,
                                         requires_arch<neon64>) noexcept {
...
template <class A>
inline batch_bool<double, A> neq(batch_bool<double, A> const& lhs,
                                 batch_bool<double, A> const& rhs,
                                 requires_arch<neon64>) noexcept {
...
template <class A>
inline batch_bool<double, A> bitwise_not(batch_bool<double, A> const& rhs,
                                         requires_arch<neon64>) noexcept {
...
template <class A>
inline batch<double, A> bitwise_andnot(batch<double, A> const& lhs, batch<double, A> const& rhs,
                                       requires_arch<neon64>) noexcept {
  return vreinterpretq_f64_u64(vbicq_u64(vreinterpretq_u64_f64(lhs), vreinterpretq_u64_f64(rhs)));
}

template <class A>
inline batch_bool<double, A> bitwise_andnot(batch_bool<double, A> const& lhs,
                                            batch_bool<double, A> const& rhs,
                                            requires_arch<neon64>) noexcept {
...
template <class A>
inline batch<double, A> min(batch<double, A> const& lhs, batch<double, A> const& rhs,
                            requires_arch<neon64>) noexcept {
...
template <class A>
inline batch<double, A> max(batch<double, A> const& lhs, batch<double, A> const& rhs,
                            requires_arch<neon64>) noexcept {
...
template <class A>
inline batch<double, A> reciprocal(const batch<double, A>& x,
...
inline batch<double, A> insert(batch<double, A> const& self, double val, index<I>,
                               requires_arch<neon64>) noexcept {
...
#define WRAP_REDUCER_INT_EXCLUDING_64(OP)                                   \
  namespace wrap {                                                          \
  inline uint8_t OP##_u8(uint8x16_t a) noexcept { return ::OP##_u8(a); }    \
  inline int8_t OP##_s8(int8x16_t a) noexcept { return ::OP##_s8(a); }      \
  inline uint16_t OP##_u16(uint16x8_t a) noexcept { return ::OP##_u16(a); } \
  inline int16_t OP##_s16(int16x8_t a) noexcept { return ::OP##_s16(a); }   \
  inline uint32_t OP##_u32(uint32x4_t a) noexcept { return ::OP##_u32(a); } \
  inline int32_t OP##_s32(int32x4_t a) noexcept { return ::OP##_s32(a); }   \
  }

#define WRAP_REDUCER_INT(OP)                                                \
  WRAP_REDUCER_INT_EXCLUDING_64(OP)                                         \
  namespace wrap {                                                          \
  inline uint64_t OP##_u64(uint64x2_t a) noexcept { return ::OP##_u64(a); } \
  inline int64_t OP##_s64(int64x2_t a) noexcept { return ::OP##_s64(a); }   \
  }

#define WRAP_REDUCER_FLOAT(OP)                                             \
  namespace wrap {                                                         \
  inline float OP##_f32(float32x4_t a) noexcept { return ::OP##_f32(a); }  \
  inline double OP##_f64(float64x2_t a) noexcept { return ::OP##_f64(a); } \
  }
...
inline typename batch<T, A>::value_type reduce_add(batch<T, A> const& arg,
                                                   requires_arch<neon64>) noexcept {
...
template <class A, class T, detail::enable_neon64_type_t<T> = 0>
inline typename batch<T, A>::value_type reduce_max(batch<T, A> const& arg,
                                                   requires_arch<neon64>) noexcept {
  using register_type = typename batch<T, A>::register_type;
  const detail::neon_reducer_dispatcher::unary dispatcher = {std::make_tuple(
...
template <class A, class T, detail::enable_neon64_type_t<T> = 0>
inline typename batch<T, A>::value_type reduce_min(batch<T, A> const& arg,
                                                   requires_arch<neon64>) noexcept {
  using register_type = typename batch<T, A>::register_type;
  const detail::neon_reducer_dispatcher::unary dispatcher = {std::make_tuple(
...
template <class A>
inline batch<double, A> select(batch_bool<double, A> const& cond, batch<double, A> const& a,
...
template <class A, class T, detail::enable_sized_unsigned_t<T, 8> = 0>
inline batch<T, A> zip_lo(batch<T, A> const& lhs, batch<T, A> const& rhs,
                          requires_arch<neon64>) noexcept {
...
template <class A>
inline batch<double, A> zip_lo(batch<double, A> const& lhs, batch<double, A> const& rhs,
                               requires_arch<neon64>) noexcept {
...
template <class A, class T, detail::enable_sized_unsigned_t<T, 8> = 0>
inline batch<T, A> zip_hi(batch<T, A> const& lhs, batch<T, A> const& rhs,
                          requires_arch<neon64>) noexcept {
...
template <class A>
inline batch<double, A> zip_hi(batch<double, A> const& lhs, batch<double, A> const& rhs,
                               requires_arch<neon64>) noexcept {
...
inline batch<double, A> extract_pair(batch<double, A> const& lhs, batch<double, A> const& rhs,
                                     std::size_t n,
...
template <class A, class T, detail::enable_sized_unsigned_t<T, 8> = 0>
inline batch<T, A> bitwise_rshift(batch<T, A> const& lhs,
...
template <class A, class T, detail::enable_sized_signed_t<T, 8> = 0>
inline batch<T, A> bitwise_rshift(batch<T, A> const& lhs, batch<T, A> const& rhs,
                                  requires_arch<neon64>) noexcept {
...
template <class A, class T>
inline batch<double, A> bitwise_cast(batch<T, A> const& arg, batch<double, A> const&,
                                     requires_arch<neon64>) noexcept {
  using caster_type =
...
inline batch<R, A> bitwise_cast(batch<double, A> const& arg, batch<R, A> const&,
                                requires_arch<neon64>) noexcept {
  using caster_type =
...
template <class A>
inline batch<double, A> bitwise_cast(batch<double, A> const& arg, batch<double, A> const&,
                                     requires_arch<neon64>) noexcept {
  return arg;
}
...
template <class B1, class B2, typename B2::value_type... V, typename B2::value_type... incr>
...
template <class B1, typename B1::value_type V0, typename B1::value_type... V1, class B2,
          typename B2::value_type... V2, typename B2::value_type... incr>
struct index_burst_impl<batch_constant<B1, V0, V1...>, batch_constant<B2, V2...>,
  ...
  using type = typename index_burst_impl<next_input, next_output,
                                         integer_sequence<value_type, incr...>>::type;
};
...
inline batch<uint8_t, A> swizzle(batch<uint8_t, A> const& self,
                                 batch_constant<batch<uint8_t, A>, V0, V1, V2, V3, V4, V5, V6, V7,
...
template <class A, uint16_t V0, uint16_t V1, uint16_t V2, uint16_t V3, uint16_t V4, uint16_t V5,
          uint16_t V6, uint16_t V7>
inline batch<int16_t, A> swizzle(
    batch<int16_t, A> const& self,
    batch_constant<batch<uint16_t, A>, V0, V1, V2, V3, V4, V5, V6, V7> idx,
    requires_arch<neon64>) noexcept {
...
template <class A, uint32_t V0, uint32_t V1, uint32_t V2, uint32_t V3>
inline batch<std::complex<float>, A> swizzle(
    batch<std::complex<float>, A> const& self,
    batch_constant<batch<uint32_t, A>, V0, V1, V2, V3> idx, requires_arch<neon64>) noexcept {
