...
// arg
template <class A, class T>
inline real_batch_type_t<batch<T, A>> arg(batch<T, A> const& self,
...
// conj
template <class A, class T>
inline complex_batch_type_t<batch<T, A>> conj(batch<T, A> const& self,
                                              requires_arch<generic>) noexcept {
...
// norm
template <class A, class T>
inline real_batch_type_t<batch<T, A>> norm(batch<T, A> const& self,
                                           requires_arch<generic>) noexcept {
...
// proj
template <class A, class T>
inline complex_batch_type_t<batch<T, A>> proj(batch<T, A> const& self,
                                              requires_arch<generic>) noexcept {
...
template <class A, class T>
inline batch_bool<T, A> isnan(batch<std::complex<T>, A> const& self,
                              requires_arch<generic>) noexcept {
