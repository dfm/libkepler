...
template <typename T>
struct make_integer_sequence_impl<std::integral_constant<T, (T)0>>
...
inline constexpr std::array<T, sizeof...(Is)> array_from_scalar_impl(
    const T& scalar, index_sequence<Is...>) noexcept {
...
template <typename T, std::size_t... Is>
inline constexpr std::array<T, sizeof...(Is)> array_from_pointer_impl(
    const T* c_array, index_sequence<Is...>) noexcept {
